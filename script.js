      ...
      Swal.fire("Awasss yaaa kalooo boong", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `${aldi} kamuu sayang ga sama ${aku}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`${aku} juga sayang banget sama ${aldi}`).then(function () {
                Swal.fire({
                  ...
                  val = e.value
                  Swal.fire(`Makasih banget ya byy udah sayang sama ${aku} ${val}%`).then(function () {
                    Swal.fire({
                      title: `Sekarang ${aldi} kangen ga sama ${aku}?`,
                      showDenyButton: true,
                      showCancelButton: false,
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhuhuhuhuhu iya ${aku} juga kangen bangett samaaa ${aldi} , makasihhh yaa :)`).then(function () {
              ...
              Swal.fire(`Yakin kamu ga sayang sama ${aku}?`, '', 'error').then(function () {
                Swal.fire('Ok deh :((')
              })
            }
          })
